...
import { MapPin, Users, Wifi, Plus, X, Pencil, Trash2, ArrowLeft } from 'lucide-react'
...
export default function ManageVenues() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const dataToSend = { ...formData, user_id: user.user_id }
      if (editingVenue) {
        await axios.put(`http://127.0.0.1:8000/api/venues/${editingVenue.venue_id}/update/`, dataToSend)
      } else {
        await axios.post('http://127.0.0.1:8000/api/venues/create/', dataToSend)
      }
      fetchVenues()
      setShowForm(false)
    ...
    <div className="py-5">
      <div className="container">
        ...
        <div className="d-flex justify-content-between align-items-start mb-4">
          <div>
            <p className="text-mono text-secondary mb-1">Admin</p>
